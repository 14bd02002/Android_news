...
public class FragmentOne extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new DBContext(Room.databaseBuilder(getActivity().getApplicationContext(), AppDatabase.class, "news.db")
                .build(), this);
          News nw = new News("Messi Scores Again", "Sport", "messi", "08.10.2017");
          News nw2 = new News("North Korea ", "Worldwide", "kim", "08.10.2017");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(dias.androidnewsapp.R.layout.recycler_view, container, false);


        db.GetDataAsync();
        //Log.d(TAG, "onCreateView: " + data.get(0).getTitle());
        RecyclerView recyclerView = view.findViewById(dias.androidnewsapp.R.id.recycler_view);
    ...
    private class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerViewHolder(LayoutInflater inflater, ViewGroup container) {
            super(inflater.inflate(dias.androidnewsapp.R.layout.card_view, container, false));

            mCardView = itemView.findViewById(dias.androidnewsapp.R.id.card_container);
            ...
            mDateView = itemView.findViewById(dias.androidnewsapp.R.id.date_holder);
        }
